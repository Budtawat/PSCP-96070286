...
```text
โจทต้องการให้สร้างโปรแกรมคำนวณเวลาที่น้ำจะท่วมและเวลาการละลายของหมึก

Input:
ตัวรับค่าตัวหนึ่ง

output:
จำนวนเต็มหนึ่งตัว ระยะเวลาการถ่วมของคนที่ถาม ถ้าไม่เป็นจำนวนเต็มให้ปัดเป็นจำนวนเต็ม

Constraints:
มีหลายคำตอบคนถามเยอะ
```
...
```text
ขั้นหนึ่ง ระบุจำนวนเต็ม S แทนพื้นที่ที่น้ำหมึกแผ่ขยายไปต่อหนึ่งวินาที
ขั้นสอง ระบุจำนวนเต็ม N แทนจำนวนคำร้องจากผู้คน
ขั้นสาม ให้โปรแกรมอ่านค่าแล้วตรวจสอบ
ขั้นสี่ดูว่าโปรแกรมปริ้นถูกมั้ย
```
