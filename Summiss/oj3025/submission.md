...
```text
ฌจทย์ให้เขียนโปรแกรมที่ทำการบอกฤดูต่างเมื่อถึงวันที่กำหนด
...
output:
บอกฤดูตามที่เราตั้งโปรแกรมไว้ว่าวันไหนเดือนไหนเป็นฤดูอะไร
...
```text
ขั้นหนึ่ง ดูว่าโจทย์ให้เราเปลี่ยนฤดูทุกๆเดือนที่เท่าไหร่
ขั้นสอง ดูว่าเดือนที่กำหนดหาร 3 ลงตัวมั้ย
ขั้นสาม ถ้าตรงให้แสดงฤดูที่เปลี่ยน ถ้าไม่ให้แสดงฤดูเดิมที่เป็นอยู่
```
...
```text
เหมือนแผนแรก เพราะคิดออกเท่านี้
...
```text
เพราะยังไม่ใช่วันที่ 21 ฤดูเลยยังไม่เปลี่ยน เป็นการแสดงให้เห็นอย่างชัดเจน
```
