...
```text
ขั้นหนึ่ง โปรแกรมอ่านinput
ขั็นสอง ตรวจว่าร้านที่ input เข้ามาเปิดอยู่กี่ร้าน
ขั้นสาม พิมพ์จน.ร้านที่เปิดอยู่
```
