...
```text
ระบบให้เขียนโปรแกรมแสดงหากคะแนนสูงสุดและต่ำสุดห่างกันสองคะแนนจะทำให้สงสัยว่ามีหน้าม้ามาโหวต
Input:
คะแนนรวม
คะแนนสูงสุด

output:
แสดง "Surprising" หรือ "Not surprising"

Constraints:
คะแนนต้องห่างกันแค่2คะแนนเท่านั้น
```
...
```text
ดูเงื่อนไขว่าเงื่อนไขคือโหวตมากกว่ากัน 2 คะแนนมั้ย
ถ้าใช่ แสดง Surprising 
ถ้าไม่ แสดง Not surprising
```
...
```text
ใช้แบบแผนแรกเลย เพราะเงื่อนไขถูกแน่นอน
```
