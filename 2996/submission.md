...
```text
โจทย์ให้เขียนโปรแกรมที่รับข้อความมาหนึ่งข้อความที่มีความยาว 5 ตัวอักษร แล้วให้ตัวอัษรสลับที่กันจากหน้าไปหลังให้เป็นหลังมาหน้าแล้วทำให้เป็นตัวเล็กทั้งหมด

input: 
ข้อความที่มีความยาว5ตัวอักษร

output:
ข้อความที่สลับที่กันแล้ว และเป็นตัวเล็ก
```
...
```text
ขั้นแรก อ่านโจทย์ให้เข้่าใจ
ขั้นสอง ดูตรง testcase ว่าผลที่ได้ควรเป็นยังไง
ขั้นสาม ลองเขียนโค้ดด้วยตัวเองดูก่อน
ขั้นสี่ ลองเขียนใส่ input ที่รับข้อความแล้วแปลงเป็๋นตัวเล็ก
ขั้นห้า ลองใส่ดูว่าจะให้กลับจากหลังไปหน้ายังไง

ถ้าไม่ได้จริงๆจึงจะถามเพื่อนครับ
```
...
```text
เหมือนแผนแรกครับเพราะข้อนี้เป็นข้อแรกๆที่พอทำไเด้วยตัวเองอยู่ครับ
```
...
```text
ลองครั้งแรกยังไม่แน่ใจ่าต้องทำแบบนี้ถูกมั้ย
```
...
```text
ลองเพิ่มเข้าไปดูแต่ยังผิดเพราะลืม ()
```
...
```text
ช่วยบอกว่าลืมใส่ lower
```

คุณยังทำอะไรด้วยตนเอง

```text
ส่วนอื่นทำด้วยตัวเองหมด
```
