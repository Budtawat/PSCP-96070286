...
```text
โจทย์ให้นำแม่สีสามสีมาผสมกันโดยใช้แม่สีสองสีจากสามสี
...
```text
ขั้นหนึ่ง สร้าง input สองค่า ที่ไว้รับสีสองสี
ขั้นสอง สร้างฟังชั่นกใช้ตรวจสอบว่าสีที่ใส่ตรงกับแม่สีมั้ย
ถ้าตรงมห้แสดงสีที่ผสมได้
ถ้าไม่ให้แสดง Error
```
...
```text
เหมือนวิธีแรกเพราะสามารถตรวจสอบได้ถูก
```
