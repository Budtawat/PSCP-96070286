...
```text
โจทให้รับ input เป้นเลขมา1จำนวน

input:
เลข

output:
จำนวนเต็มบวกตั้งแต่ N ถึง 0 ที่หารด้วย 10 ลงตัว

Constraints:
ต้องหาร 10 ลงตัวเท่านั้น
```
...
```text
ขันแรก ใส่เลข
ขั้นสอง ตรวจว่านับถึง 0 มั้ย
ชั้ยสาม ตรวจว่าแสดงผลไล่ลงมาแบบ 50 40 30 20 10 0 มั้ย
```
...
```text
ถูกเพราะโจทต้องการแค่ที่หาร 10 ลงตัว
