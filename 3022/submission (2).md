...
```text
โจทย์ต้องการให้ทำการเปลี่ยนอุณหภูมิจากหน่วยหนึ่งไปอีกหน่อยหนึ่งโดยการใช้สูตรการแปลงอุณหภูมิ
...
output:
โปรแกรมคำนวณอุณหภูมิจาก 1 เป็น หน่วยที่2

Constraints:
ต้องใช้สูตรเปลี่ยนอุณหภูมิแบบเฉพาะเท่านั้น
```
...
```text
ดูหน่วยที่ต้องการจะเปลี่ยน
เช็คว่าสูตรที่ใช้ถูกต้อง
ถ้าถูกโปรแกรมจะคำนวณจากเลขที่ใส่ไป
```
