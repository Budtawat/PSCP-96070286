...
```text
ลองใส่ code ที่ตัวเองเขียนห้ AI ดูแล้วถามว่าทำไมไม่ผ่าน
```
...
```text
AI ช่วยบอกว่าสิ่งที่ขาดคือ min ที่ิอยู่บรรทัด 11
```
...
```text
ได้เรียนรู้ว่าการอ่านโจทย์ดีๆและครบถ้วนเป็นสิ่งสำคัญควรอ่านซ้ำอย่่างน้อย2รอบเพื่อกันส่วนที่ข้าม
```
