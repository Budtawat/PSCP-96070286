...
```text
โจทย๋ให้กำหนดค่าบริการ 10% ของค่าอาหาร และ vat 7% ของค่าชำระทั้งหมด

Input:
ค่าอาหาร

Output:
ค่าอาหาร + ค่าบริการ +Vat

Constraints:
Input คือค่าอาหารที่ยังไม่รวม ค่าบริการและVat
```
...
```text
ขั้นหนึ่ง สร้างตัวรับข้อมผุลตัวเลข
ขั้นสอง สร้างฟังชัน+ค่าบรอการ
ขั้นสี่ นำค่าบริการรวมค่าอาหารมา+Vat
```
...
```text
ลองถามเพื่อนว่าฟังชั่นที่ใช้คืออะไร
```
